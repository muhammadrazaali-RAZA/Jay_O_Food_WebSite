            ...
            <div class="row">
              <div class="col-lg-10 col-xl-7 mx-auto">
               <h3 class="display-4">Pattern <?php echo $pattern; ?></h3>
                 <form action="into_database.php" method="post">
...
<input type="text" name="sewer" value="<?php echo $sewer; ?>"
required="required" autofocus=""class="form-control border-3 shadow-sm px-6">
                  </div>
                  <div class="form-group mb-4">
<label for="stromwt">City StormWater</label>        
<input type="text" name="stromwt" value="<?php echo $stromwt; ?>"
required="required" autofocus=""class="form-control border-3 shadow-sm px-6">
                  </div>
                  <div class="form-group mb-4">
...
<input type="text" name="ser_prd" value="<?php echo "  From: ";echo $ser_prdf; echo "     To: "; echo $ser_prdl; ?>"
required="required" autofocus=""class="form-control border-3 shadow-sm px-6">
                  </div>
                  <div class="form-group mb-4">
