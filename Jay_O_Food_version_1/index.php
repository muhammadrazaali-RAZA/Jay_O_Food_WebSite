      ...
      <section class="banner_main">
         <div class="container">
            <div class="row d_flex">
               <div class="col-md-5">
                  <div class="text-bg">
                     <h1>Multiple Bill<br> Data Analysis</h1>
                     <span>by Clifford in 2022</span>
                     <p>Provid some creative and simple graphs from Bills data to get information for future and undersrtand the trand which is helpful  for busisness  </p>
                     <a href="sign_in_up.php">Get Started</a>
                  </div>
               </div>
               <div class="col-md-7">
                  <div class="text-img">
      ...
      <div id="about" class="hosting">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <div class="titlepage">
                     <h2>What’s New In Data Analysis</h2>
                  </div>
               </div>
            </div>
            <div class="row">
